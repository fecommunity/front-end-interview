...
### 1.1 OSI七层模型
![OSI七层参考模型](../img/OSI-七层模型.png)

### 1.2 TCP/IP五层模型
![TCP/IP五层模型](../img/TCP-IP-五层模型.png)

### 1.3 各层的设备
![各层设备](../img/TCP模型-各层设备.png)

### 1.4 各层对应协议
![各层协议](../img/TCP模型-各层协议.png)
...
### 2.2 数据包结构
![数据包](../img/http-data.jpg)

**数据包细节**

![详细信息](../img/http-data-detail.jpg)
...
### 参考链接：https://blog.csdn.net/sinat_21455985/article/details/53508115
...
### 2.6.1 Post 和 Get 的区别
 ...
 - `重点`POST，浏览器先发送header，服务器响应100 continue，浏览器再发送data，服务器响应200 ok(返回数据)
